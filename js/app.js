(() => {
 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        const mytippys = tippy_esm("[data-tippy-content-one]", {
            arrow: false,
            allowHTML: true,
            offset: [ -78, 20 ],
        ...
        setTimeout((() => {
            if (document.documentElement.classList.contains("touch")) mytippys.forEach((mytippy => {
                mytippy.setProps({
                    trigger: "click"
                });
            }));
        }), 1);
        modules_flsModules.tippy = mytippys;
        ...
        function initSliders() {
            if (document.querySelector(".popular-product__slider")) new swiper_core_Swiper(".popular-product__slider", {
                ...
                navigation: {
                    prevEl: ".navigation-product__button-prev",
                    nextEl: ".navigation-product__button-next"
                },
                breakpoints: {
                    0: {
                        slidesPerView: 1,
        ...
        da.init();
        window.addEventListener("load", siteIsLoaded());
        function siteIsLoaded() {
            setTimeout((() => {
                let preload = document.querySelector("body.preload");
                if (preload) preload.classList.remove("preload");
            }), 0);
        }
        window["FLS"] = false;
        isWebp();
